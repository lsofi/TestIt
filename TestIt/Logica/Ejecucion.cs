...
namespace TestIt.Logica
{
    public class Ejecucion
    {
        ...
        public static List<Ejecucion> buscarEjecuciones()
        {
            return eDao.buscarEjecuciones();
        }

        public static List<Ejecucion> filtrarEjecuciones(int test, int deportista, DateTime fechaDesde, DateTime fechaHasta)
        {
            return eDao.filtrarEjecuciones(test, deportista, fechaDesde, fechaHasta);
        }
        ...
        public bool grabar()
        {
            idUsuario = Globals.UsuarioActual.IdUsuario;
            return eDao.Create(this);
        }

        public bool actualizar()
        {
            return eDao.Update(this);
        }

        public bool eliminar()
        {
            return eDao.Delete(this);
        }
